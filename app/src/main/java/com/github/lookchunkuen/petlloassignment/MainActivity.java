...
public class MainActivity extends AppCompatActivity implements  AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dogList.add(new Dog(R.drawable.dog11, "Steven", "Female, 5 Years 2 Months"));
        dogList.add(new Dog(R.drawable.dog21, "Jacky", "Male, 2 Months"));
        dogList.add(new Dog(R.drawable.dog31, "Coco", "Female, 2 Months"));
        dogList.add(new Dog(R.drawable.dog41, "Keke", "Female, 2 Months"));
        dogList.add(new Dog(R.drawable.dog51, "Caha", "Female, 5 Months"));
